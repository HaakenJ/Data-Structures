...
private:
    ...
    /**
     * Remove a patient from the queue by their arrivalID
     * throws invalid_argument exception if no Patient is found
     * @param arrivalID the id of the Patient to search for
     * @return          the Patient if found
     */
    Patient removePatientByArrival(int arrivalID);
};
